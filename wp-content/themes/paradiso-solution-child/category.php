...
<div class="sidebar-page-container">
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <!-- =========================
                 Content Side (Category Posts Loop)
            ========================== -->
            <div class="content-side col-lg-8 col-md-12 col-sm-12">
                <div class="blog-classic">
                    <?php
                    // Standard WordPress loop automatically fetches posts for the active category
                    if (have_posts()) :
                        while (have_posts()) : the_post();
                            ...
                            $thumbnail  = has_post_thumbnail($post_id) 
                                ...
                                : '<img src="' . esc_url(get_stylesheet_directory_uri() . '/assets/images/no-image.png') . '" alt="' . esc_attr($post_title) . '">';
                    ?>
                        <!-- News Block Five -->
